...
STACK.this_file_lineno_should_ignore(399, check_text='return test(*args, **kwargs, _debug_default=debug_default, _debug_debug=debug_debug, _force_raise=force_raise)')
STACK.this_file_lineno_should_ignore(409, check_text='re_value = self.func(*self.args, **self.kwargs)')
STACK.this_file_lineno_should_ignore(470, check_text='return self.ori(*args, _debug_default=debug_default, _debug_debug=debug_debug, _force_raise=force_raise, **kwargs)')
STACK.this_file_lineno_should_ignore(480, check_text='re_value = self.func(*args, **kwargs)')
STACK.this_file_lineno_should_ignore(576, check_text='re_value = temp(*args, **kwargs)')
